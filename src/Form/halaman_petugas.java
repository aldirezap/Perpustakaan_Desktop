 ...
 * @author User
 */
public class halaman_petugas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel_anggota.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(43, 29, -1, 57));

        jLabel5.setFont(new java.awt.Font("Century Gothic", 0, 18)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Anggota");
        jPanel_anggota.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 90, 90, 30));
        ...
        body.add(jPanel_kembali, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 300, 150, 140));
    ...
    private void anggotaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_anggotaActionPerformed
        // TODO add your handling code here:
        lihat_anggota_petugas la = new lihat_anggota_petugas();
        la.show();
        this.dispose();
    ...
    private void peminjamanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_peminjamanActionPerformed
        // TODO add your handling code here:
        Peminjaman_petugas pm = new Peminjaman_petugas();
        pm.show();
        this.dispose();
    ...
    private void pegembalianActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pegembalianActionPerformed
        // TODO add your handling code here:
        Pengembalian_petugas pb = new Pengembalian_petugas();
        pb.show();
        this.dispose();
    ...
    private void transaksiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_transaksiActionPerformed
        // TODO add your handling code here:
        lihat_history_petugas tr = new lihat_history_petugas();
        tr.show();
        this.dispose();
    ...
    private void bukuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bukuActionPerformed
        // TODO add your handling code here:
        lihat_buku_petugas lh = new lihat_buku_petugas();
        lh.show();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(halaman_petugas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new halaman_petugas().setVisible(true);
            }
        });
    }
